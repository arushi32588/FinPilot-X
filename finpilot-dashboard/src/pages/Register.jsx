  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#18181b]">
      ...
      <form onSubmit={handleSubmit} className="relative z-10 bg-background-glass/90 border-2 border-fuchsia-500/40 shadow-2xl backdrop-blur-2xl px-8 py-10 w-full max-w-md flex flex-col items-center" style={{
        ...
        <h2 className="text-xl font-bold mb-2 text-fuchsia-200">Create your account</h2>
        {/* Email Input */}
        ...
        {/* Display Name Input */}
        <div className="w-full mb-4 relative">
          <FaUser className="absolute left-4 top-1/2 -translate-y-1/2 text-fuchsia-400 text-lg" />
          <input
            type="text"
        ...
        {success && <div className="w-full mb-2 text-center text-emerald-300 bg-emerald-900/30 rounded-xl py-2 px-4 animate-fadein" style={{fontSize: '0.95rem'}}>{success}</div>}
        {/* Register Button */}
        <button
          type="submit"
          disabled={loading}
        ...
        <div className="w-full text-center mt-4 text-fuchsia-200">
          ...
          <Link to="/login" className="underline hover:text-fuchsia-400 transition-all">Login</Link>
        </div>
      </form>
      <style>{`
        @keyframes fluid-bg {
